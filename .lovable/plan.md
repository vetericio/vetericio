...
## 2. Menu
- Botões: **Início** e **Animais registrados** (com a quantidade). Plantões e Evolução saem do menu e passam a ser botões dentro da página de Animais registrados.
- Abaixo dos botões, no cabeçalho: **"Total de registros do plantão de hoje: N"**, sempre atualizado automaticamente.
